<span id="Fundamental Networking" class="anchor"><span id="fundamental-networking" class="anchor"></span></span>

![](_chameleon/networking/1/media/image3.png)
...
![](_chameleon/networking/1/media/image5.png)
...
![](_chameleon/networking/1/media/image6.png)
...
![](_chameleon/networking/1/media/image7.png)

![](_chameleon/networking/1/media/image8.png)*Normal* view, you should see a screen similar to what follows. First, the similarities are the same display for the two networks present within the project including the same colors and **CIDR\*** display for subnets as well as the attached devices.
...
![](_chameleon/networking/1/media/image9.png)
...
![](_chameleon/networking/1/media/image10.png)
...
![](_chameleon/networking/1/media/image11.png)
...
![](_chameleon/networking/1/media/image12.png)

![](_chameleon/networking/1/media/image13.png)inally, after reviews all details laid out, create the network by clicking on **Create**.
...
![](_chameleon/networking/1/media/image14.png)
...
![](_chameleon/networking/1/media/image16.png)
...
![](_chameleon/networking/1/media/image17.png)
...
![](_chameleon/networking/1/media/image26.png)

Once satisfied, confirm the creation of the interface by clicking on **Add Interface**.

![](_chameleon/networking/1/media/image27.png)
