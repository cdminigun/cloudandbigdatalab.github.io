...
gist_id: cloudandbigdatalab/596955e7f4e7ff33af4e
---
...
`-p tutorial` specifies our project name. Otherwise it uses the name of the current directory. If the images had been changed and we wanted to run the updated versions we would run `docker-compose pull` and `docker-compose -p tutorial up -d` and the images would be pulled and our containers restarted.
...
{% gist 596955e7f4e7ff33af4e docker-compose-ps-1.txt %}
...
{% gist 596955e7f4e7ff33af4e swarm-master.sh %}

### Swarm Nodes

Here we're using a bash loop to create 2 nodes.

{% gist 596955e7f4e7ff33af4e swarm-nodes.sh %}
...
{% gist 596955e7f4e7ff33af4e docker-info.txt %}
...
{% gist 596955e7f4e7ff33af4e docker-compose-ps-2.txt %}
...
{% gist 596955e7f4e7ff33af4e docker-compose-ps-3.txt %}
...
{% gist 596955e7f4e7ff33af4e docker-ps-1.txt %}
